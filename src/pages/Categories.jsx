...
const past_categories = [
    { fitClass: "widget-flower", image: widget_flower, category: "Best Women and Gender Hack", description: "Best hack that promotes women and gender minorities." },
    { fitClass: "watering-pail", image: watering_pail, category: "Best Wellness Hack", description: "Best hack that promotes the health and wellness of its users."},
    { fitClass: "teacup", image: teacup, category: "Best Accessible UI", description: "Best UI/UX project with an emphasis on inclusivity/accessibility." },
    ...
    { fitClass: "boots", image: boots, category: "Best Game Hack", description: "Best hack with gameplay." },
    { fitClass: "flower", image: flower, category: "Failure to Launch", description: "Best hack that didn't happen to work out in the end." },
    { fitClass: "ribbon", image: ribbon, category: "Fan Favorite", description: "Best hack according to hackers." },
    ...
    return (
        <div className="categories-background section">
            <div className ="categories">
                <h2>Past Categories (WiCHacks 2025)</h2>
